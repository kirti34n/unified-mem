...
// --- ranking properties -----------------------------------------------------------------
// DELIBERATELY LAST. Every test in this file shares one vault, and these fixtures add 14 notes.
// Placed earlier, they changed the corpus the supersede tests score against, and on the no-FTS5
// fallback path (the Node 22.13 floor, where similarity is an absolute overlap score rather than
// normalized against the best hit) that was enough to push a superseded note out of the top k and
// fail three tests that had nothing to do with this change. CI caught it on 22.13 while 24.x stayed
// green. Run UNIFIED_MEM_NO_FTS=1 node --test test/vault.test.mjs before trusting a local pass.
